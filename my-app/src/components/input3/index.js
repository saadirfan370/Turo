...
function Slider6() {
    const Fill6 = [
        ...
        },
        {
            ...
            Det2:"Deluxe & Super Deluxe",
        },
        {
            id:3,
            Img:"https://resources.turo.com/f/81934/328x262/0d5b069ff2/image_experience_petfriendly.jpg",
        ...
        {
            id:4,
            Img:"https://resources.turo.com/f/81934/328x262/61e1aebed5/image_experience_convertibles.jpg",
        ...
        {
            id:4,
            Img:"https://resources.turo.com/f/81934/328x262/6a22a954a4/image_experience_allwheeldrive.jpg",
            ...
            Det2:"All-wheel drive",
        },
        {
            id:4,
            Img:"https://resources.turo.com/f/81934/328x262/294b8f8aec/image_experience_classiccars.jpg ",
    ...
    return (
        <div className="show3">
            ...
            <Slider {...settings}>
                {Fill6.map((value,i)=>{
                    return(
                    <div key={i} className="show33">
                        <Card className="show31">
                            <Card.Img variant="top" src={value.Img} />
                            <Card.Body>
                                <div className="show32">
                                    {value.Det1}
                                    <p>{value.Det2}</p>
                                </div>
                            </Card.Body>
